from FaceUtil import contrast_faces, convert_to_image, real_time_comparison, get_face_encoding
import cv2
import base64
from datetime import datetime
print("开始识别人脸")
start_time = datetime.now()
base64_code = "/9j/4AAQSkZJRgABAQAAAQABAAD/2wBDAAgGBgcGBQgHBwcJCQgKDBQNDAsLDBkSEw8UHRofH" \
              "h0aHBwgJC4nICIsIxwcKDcpLDAxNDQ0Hyc5PTgyPC4zNDL/2wBDAQkJCQwLDBgNDRgyIRwhMjIyM" \
...
known_image = convert_to_image(base64_code)
...
unknown_image = convert_to_image(b)
result = contrast_faces(known_image, unknown_image)
with open("c:/Users/lenovo/Desktop/ad.jpg") as a:
...
real_time_comparison(known_face_encodings, known_face_names)
